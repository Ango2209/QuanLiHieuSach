...
public class PanelTrangChuKH extends JPanel {
	...
	public PanelTrangChuKH() {
		...
		lblNewLabel.setIcon(new ImageIcon(getClass().getResource("/img/hinh-nen.jpg")));
		...
		btnNewButton.setIcon(new ImageIcon(getClass().getResource("/img/Button-Log-Off-icon.png")));
