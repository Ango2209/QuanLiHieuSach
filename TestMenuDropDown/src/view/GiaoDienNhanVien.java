...
public class GiaoDienNhanVien extends javax.swing.JFrame {
    ...
    private void execute() {
        ...
        ImageIcon iconBook = new ImageIcon(getClass().getResource("book-search.png"));
        ImageIcon iconCustomer = new ImageIcon(getClass().getResource("customer-icon.png"));
        ImageIcon iconDatabase = new ImageIcon(getClass().getResource("bill-icon.png"));
        ImageIcon iconThongKe= new ImageIcon(getClass().getResource("main-books-icon.png"));
        ImageIcon iconMainPage = new ImageIcon(getClass().getResource("Help-icon.png"));
